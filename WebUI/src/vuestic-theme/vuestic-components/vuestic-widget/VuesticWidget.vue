<template>
  <div class="widget" :class="{'no-header': !headerText}">
    <div class="widget-header" v-if="headerText">
      ...
      <div v-if="buttonText" class="col">
        <div class="row text-right">
          <div class="col">
            <router-link :to="buttonRoute" tag="button" class="btn btn-secondary btn-micro">{{buttonText}}</router-link>
          </div>
        </div>
      </div>
    </div>
...
<script>
  export default {
    ...
    props: ['headerText', 'buttonText', 'buttonRoute']
  }
</script>
