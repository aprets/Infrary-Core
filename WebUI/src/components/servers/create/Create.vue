        ...
        <vuestic-widget class="no-h-padding" headerText="Server Creation Wizard">
          <vuestic-wizard
            ...
            <div slot="provider" class="form-wizard-tab-content">
              ...
              <div v-show='isDo' class="form-group with-icon-right" :class="{'has-error': errors.has('doToken'), 'valid': isFormFieldValid('doToken')}">
            ...
            <div slot="properties" class="form-wizard-tab-content">
              ...
              <div class="form-group with-icon-right" :class="{'has-error': errors.has('doServerName'), 'valid': isFormFieldValid('doServerName')}">
                <div class="input-group">
                  <input
                    name="doServerName"
                  ...
                  <small v-show="errors.has('doServerName')" class="help text-danger">{{ errors.first('doServerName') }}</small>
                </div>
              </div>
              ...
              <div class="form-group with-icon-right" :class="{'has-error': errors.has('doServerKey'), 'valid': isFormFieldValid('doServerKey')}">
                <div class="input-group">
                  <textarea
                    name="doServerKey"
                    v-model="doServerKey"
                  ...
                  <small v-show="errors.has('doServerKey')" class="help text-danger">{{ errors.first('doServerKey') }}</small>
                </div>
              </div>
            ...
            <div slot="configuration" class="form-wizard-tab-content">
              <p>
                Select all the desired server properties. A server with those properties will be created with your
                privier using the API key you specified (on your account). You will have full control to stop or remove
                the server at any time. The provider will bill you for the server as usual.
              </p>
              ...
              <div class="table-responsive">
                <table class="table first-td-padding">
                  ...
                  <tr>
                    ...
                    <td><pre style="width: 30rem">{{doServerKey}}</pre></td>
                  </tr>
                  <tr>
  ...
  export default {
    ...
    data () {
      return {
        ...
        doServerImage: 'ubuntu-14-04-x64',
      ...
      postServerData () {
        if (this.doToken) {
          this.axios.post('/servers/provision/create', {
            serverProperties: {
              SERVER_PROVIDER: this.provider,
              ACCESS_TOKEN: this.doToken,
              SERVER_NAME: this.doServerName,
              SERVER_SIZE: this.doServerSlug,
              SERVER_IMAGE: this.doServerImage,
              SERVER_LOCATION: this.doServerLocation,
